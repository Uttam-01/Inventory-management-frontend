  ...
  return (
    <div>
      {pathParts[pathParts.length - 1] === "login" ? (
        ...
        <div className="fixed bg-[#ffffff] h-[64px] w-[calc(100%-256px)] top-0 px-5 z-100 [box-shadow:0_1px_4px_rgba(0,0,0,0.1)]">
          <div className="flex justify-between items-center h-[64px]">
            <div className="text-[#0F4C81] text-[24px] font-bold">
