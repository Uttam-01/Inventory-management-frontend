...
export default function () {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    updateVendorMutation.mutate(reqdataa);
  };
  ...
  return (
    ...
    >
      ...
      <div className="text-[#343A40] bg-[#DBEAFE] flex px-4 rounded-[8px] mt-5 text-[14px] font-normal  font-emoji h-[94px] items-center">
        Update existing vendor's details. Comprehensive vendor records help
        streamline procurement and quality control.
      </div>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="w-full flex h-[42px] items-center justify-end gap-4 mt-[25px]">
          <Link
            ...
            className="border-[#6B7280] hover:cursor-pointer  h-[42px] text-emoji border-[1px] rounded-[8px] w-[81px]  text-[#6B7280] text-[16px] font-normal flex items-center justify-center"
          >
            Cancel
          </Link>
