  ...
  return (
    <div className="w-[1404px] mx-auto flex flex-col bg-[#ffffff] rounded-[8px] p-8 justify-start ">
      ...
      <div className="flex justify-between items-center">
        <AddButton to="/vendor-management/add-new-vendor" text="Add New Component" />
      ...
      <div className="border-[1px] mt-[10px] rounded-[6px] border-[#D1D5DB]">
        ...
        {Array.from({ length: 2 }).map((_, index) => (
          ...
          >
            ...
            <div className="w-[20%] flex justify-center">123456789</div>
            <div className="w-[20%] flex justify-center">City A</div>
            <div className="w-[20%] flex justify-center">GST12345</div>
