...
import { useRejected } from "@/lib/hooks/useRejected";
    ...
    <div className=" mx-auto flex flex-col rounded-[8px]  justify-start">
      ...
      <div className=" mx-auto flex flex-col bg-[#ffffff] rounded-[8px] p-10 justify-start shadow ">
        ...
        <div className="text-[#343A40] bg-[#DBEAFE] flex px-4 rounded-[8px] mt-5 mb-3 text-[14px] font-normal  font-emoji h-[54px] items-center">
          This report contains all materials that have been rejected or
          scrapped. Please review the details carefully.
        </div>
        ...
        <div className=" mt-[10px] mb-5 rounded-[6px] border-[1px] border-[#D1D5DB] shadow">
          <div className="flex justify-between bg-[#E5E7EB] h-[41px] items-center">
            <div className="w-[16.6%] flex justify-center items-center text-[#4B5563] text-[16px] font-bold gap-1">
              Material Name
            </div>
            <div className="w-[16.6%] flex justify-center items-center text-[#4B5563] text-[16px] font-bold gap-1">
              Quantity{" "}
          ...
          {Array.from({ length: 5 }).map((_, index) => (
            <div
              key={index}
              className={`flex justify-between items-center h-[41px] ${
                index != 4 ? "border-b-[1px] border-[#D1D5DB]" : ""
              }`}
            >
              <div className="w-[16.6%] flex justify-center items-center text-[#000000] text-[16px] font-normal font-emoji">
                Material A
              </div>
              <div className="w-[16.6%] flex justify-center items-center text-[#000000] text-[16px] font-normal font-emoji">
                100
