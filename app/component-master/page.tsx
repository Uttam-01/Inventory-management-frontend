  ...
  return (
    <div className="w-[1404px] mx-auto flex flex-col bg-[#ffffff] rounded-[8px] p-8 justify-start ">
      ...
      <div className="flex justify-between items-center">
        <AddButton to="/component-master/add-new-component" text="Add New Component" />
      ...
      <div className="border-[1px] rounded-[6px] border-[#D1D5DB]">
        ...
        {Array.from({ length: 2 }).map((_, index) => (
          ...
          >
            ...
            <div className="w-[14.2%] flex justify-center">Nozzle BC 5 mm</div>
            <div className="w-[14.2%] flex justify-center">100</div>
            <div className="w-[14.2%] flex justify-center">50</div>
            <div className="w-[14.2%] flex justify-center">10</div>
            <div className="w-[14.2%] flex justify-center">Warehouse 1</div>
