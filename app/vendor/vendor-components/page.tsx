...
import { useVendorComponents } from "@/lib/hooks/vendor-componentApi/useVendorComponents";
import { useEffect, useState } from "react";
import { useVendorComponentDelete } from "@/lib/hooks/vendor-componentApi/useDeleteVendorComponent";
  ...
  return (
    <div className=" mx-auto flex flex-col bg-[#ffffff] rounded-[8px] p-8 justify-start ">
      ...
      <div className="flex justify-between items-center">
        <AddButton
          to="/vendor/vendor-components/add-new-vendor-component"
              ...
              <tr key={index} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-3 border border-gray-300">
                  <div className="flex gap-2">
                    <Edit
                      to={`/vendor/vendor-components/edit-vendor-component/${unit.id}`}
                    />
                    <button
