...
import { useDeleteVendor } from "@/lib/hooks/vendorApi/useDeleteVendor";
    ...
    <div className=" mx-auto flex flex-col bg-[#ffffff] rounded-[8px] p-8 justify-start ">
      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-5">
          <AddButton
            to="/vendor/vendor-management/add-new-vendor"
            text="Add New Vendor"
          />
          <AddButton to="/vendor/vendor-components" text="Add component" />
        </div>
        <div className="flex gap-5">
                ...
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-3 border border-gray-300">
                    <div className="flex gap-2">
                      <Edit
                        to={`/vendor/vendor-management/edit-vendor/${vendor.id}`}
                      />
                      <div
                        onClick={() => {
