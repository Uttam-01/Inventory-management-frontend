  ...
  return (
    <div className="w-[1404px] mx-auto flex flex-col bg-[#ffffff] gap-8 rounded-[8px] p-8 justify-start shadow">
      ...
      <div className="text-[#343A40] bg-[#DBEAFE] flex px-4 rounded-[8px] text-[14px] font-normal  font-emoji h-[54px] items-center">
        This screen allows for the aggregation and breakdown of costs associated
      ...
      <div className="flex flex-col border-[1px] border-[#D1D5DB]">
        ...
        <div className="flex h-[64px] w-full">
          <div className="w-[83.4%] flex justify-end items-center pr-3 text-[16px] font-bold">Material Subtotal: </div>
          <div className="w-[16.6%] flex justify-start items-center border-l-[1px] border-[#D1D5DB] mr-[7px] pl-3 text-[16px] font-bold">₹1000.00 </div>
        </div>
      </div>
      ...
      <div className="bg-[#F3F4F6] h-[80px] flex flex-col items-start justify-center px-4" > 
        <div className="font-emoji font-normal text-[16px]">Labour (Ramesh): ₹1,200.00</div>
        <div className="font-emoji font-normal text-[16px]">Transport: ₹500.00</div>
      </div>
      <div className="w-full flex justify-end font-bold text-[16px] rounded-[4px] -mt-[20px]">Additional Costs Subtotal: ₹1,700.00</div>
      <div className="w-full flex justify-end font-bold text-[24px] text-[#0F4C81] bg-[#E0F2F7] h-[80px] items-center pr-6 rounded-[4px]">Grand Total Cost: ₹3,700.00</div>
      <div className="w-full flex justify-end font-bold text-[16px]">
        <button className="bg-[#6B7280] rounded-[4px] h-[40px] w-[140px] flex items-center justify-center text-[#FFFFFF] font-normal font-emoji"> Get Print
        </button>
        </div>
    </div> 
  );
