...
import { useAddMachines } from "@/lib/hooks/machineApi/useAddMachines";
  ...
  useEffect(() => {
    if (addMachineMutation.isSuccess) {
      const timeout = setTimeout(() => {
        router.push("/inventory/machine-management");
      }, 1000);
        ...
        <form onSubmit={formSubmit}>
                      ...
                      <svg
                        ...
                        onClick={() =>
                          setReqComponents((prev) =>
                            prev.filter(
                              (component) =>
                                component.name != selected.displayName
                            )
                          )
                        }
                        width="15"
          ...
          />
            <div className="flex flex-col justify-end">
              <input
                ...
                className="h-[50px] w-[300px] border-[1px] border-[#D1D5DB]  rounded-[6px] px-3"
                type="number"
          ...
          <div className="mt-[25px] flex justify-between w-full">
            ...
            <div className="w-full flex h-[42px] items-center justify-end gap-4">
              <Link
                href={"/inventory/machine-management"}
