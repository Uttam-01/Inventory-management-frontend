...
import { useDeleteMachine } from "@/lib/hooks/machineApi/useDeleteMachine";
    ...
    <RoleProtected allowedRoles={["SUPER_ADMIN", "MANAGER", "ADMIN"]}>
      <div className=" mx-auto flex flex-col h-min bg-[#ffffff] rounded-[8px] p-8 justify-start ">
        ...
        <div className="flex justify-between items-center">
          <AddButton
            to="/inventory/machine-management/add-new-machine"
                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-3 border border-gray-300">
                      <div className="flex gap-2">
                        <Edit
                          to={`/inventory/machine-management/edit-machine/${machine.id}`}
                        />
                        <button
                          type="button"
