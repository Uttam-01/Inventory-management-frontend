  ...
  return (
    <div className="w-[1404px] mx-auto flex flex-col bg-[#ffffff] rounded-[8px] p-8 justify-start ">
      ...
      <div className="flex justify-between items-center">
        <AddButton
          to="/component-management/add-new-component"
      ...
      <div className="border-[1px] rounded-[6px] border-[#D1D5DB]">
        <div className="flex justify-center bg-[#FFFFFF] h-[41px] items-center border-[#D1D5DB] border-b-[1px]">
          ...
          <div className="w-[14.2%] flex justify-center">AVAILABLE STOCK</div>
          <div className="w-[14.2%] flex justify-center">MIN STOCK</div>
          <div className="w-[14.2%] flex justify-center">RESERVED</div>
          <div className="w-[14.2%] flex justify-center">LOCATION</div>
          <div className="w-[14.2%] flex justify-center">ACTIONS</div>
        </div>
        {data.map((component: Component, index: number) => (
          ...
          >
            <div className="w-[14.2%] flex justify-center">
              {component.status === "OK" ? (
                <svg
                  width="12"
                  height="19"
            ...
            <div className="w-[14.2%] flex justify-center">{component.name}</div>
            <div className="w-[14.2%] flex justify-center">{component.availableStock}</div>
            <div className="w-[14.2%] flex justify-center">{component.minimumStock}</div>
            <div className="w-[14.2%] flex justify-center">10</div>
            <div className="w-[14.2%] flex justify-center">{component.locationInStore}</div>
            <div className="w-[14.2%] flex justify-center items-center gap-4">
              <Edit to={`/component-management/edit-component/${component.id}`} />
              <button  type="button" 
