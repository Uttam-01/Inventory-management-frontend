...
function InputBox(e: { label: string; placeholder: string; button: boolean ; name : string ; error? : string ; defaultValue? : number | string }) {
  return (
    ...
    >
      ...
      <div className="mt-[25px]">
        <div className="flex flex-wrap gap-x-6 gap-y-8 mt-[10px]">
          ...
          <div className="flex flex-col">
            <label className="text-[#343A40] text-[14px] font-normal" htmlFor="">Units</label>
            <select defaultValue={componentInfo?.units} name="units" id="" className="h-[50px]  w-[338px] border-[1px] border-[#D1D5DB]  rounded-[6px] px-3 shadow-[0px_0px_0px_0px_#0000001A,0px_0px_0px_0px_#0000001A,0px_1px_2px_0px_#0000000D]">
            <option className="h-[50px]  w-[338px] border-[1px] border-[#D1D5DB]  rounded-[6px] px-3" value="KG">Kilogram</option>
          ...
          <InputBox defaultValue={componentInfo?.dimension} error={formErrors.dimension} name="dimension" label="Dimensions" placeholder="" button={false} />
          <InputBox
          name="minimumStock"
            label="Minimum Stock"
      ...
      <div className="w-full flex h-[42px] items-center justify-between gap-4 mt-[25px]">
        {updateComponentMutation.isSuccess && (
            ...
            {updateComponentMutation.isError && <div>Error updating machine.</div>}
        <div className="w-full flex h-[42px] items-center justify-end gap-4 ">
          <Link href="/component-management" className="border-[#6B7280] h-[42px] text-emoji border-[1px] rounded-[8px] w-[81px]  text-[#6B7280] text-[16px] font-normal flex items-center justify-center">
          Cancel
        </Link>
