...
function InputBox(e: { label: string; placeholder: string; button: boolean ; name : string ; error? : string ; defaultValue? : number }) {
  return (
      ...
      <div className="mt-[25px]">
        <div className="flex flex-wrap gap-x-6 gap-y-8 mt-[10px]">
          ...
          <div className="flex flex-col">
            ...
            <select name="units" id="" className="h-[50px]  w-[338px] border-[1px] border-[#D1D5DB]  rounded-[6px] px-3 shadow-[0px_0px_0px_0px_#0000001A,0px_0px_0px_0px_#0000001A,0px_1px_2px_0px_#0000000D]">
          ...
          <InputBox error={formErrors.dimension} name="dimension" label="Dimensions" placeholder="" button={false} />
          <InputBox
          name="minimumStock"
            label="Minimum Stock"
