    ...
    <div className="w-[1404px] mx-auto flex flex-col bg-[#ffffff] rounded-[8px] p-8 justify-start ">
      ...
      <div className="border-[1px] mt-[10px] rounded-[6px] border-[#D1D5DB] ">
        <div className="flex justify-center  h-[41px] items-center border-b-[1px] py-2 border-[#D1D5DB] font-bold text-[16px]" >
          ...
          <div className="w-[20%] flex justify-center">Last Login </div>
        ...
        {Array.from({ length: 3 }).map((_, index) => (
          <div
            ...
            className={`flex justify-evenly  items-center h-[64px] font-normal text-[16px] ${
              index  === 2 ? "" : "border-b-[1px] border-[#D1D5DB]"
            }`}
          >
            <div className="w-[20%] flex justify-center font-normal text-[16px]">user@gmail.com</div>
            <div className="w-[20%] flex justify-center">
              <div className="bg-[#BFDBFE] h-[29px] rounded-[4px] px-4 flex items-center">{index % 2 === 0 ? "Admin" : "User"}</div>
              
            </div>
            <div className="w-[20%] flex justify-center">2023-10-01</div>
            <Status index={index} />
